...
trying to find the mean for the control vs tx 1.find which columns in **counts** correspond to the control conditions (no drugs) 2.calculate the mean count value for each gene.
...
![](class15_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
Adding annotation data use the merge() function to add annotation
